...
const connection = mysql.createConnection({
  host: 'sql10.freemysqlhosting.net',        // Dirección server sql
  user: 'sql10747992',             // Usuario a utilizar en mysql
  password: '1z5QS3Dnlt',         // Contrasena
  database: 'sql10747992' // Nombre de la base de datos que vas a utilizar / Revisar Script
});
